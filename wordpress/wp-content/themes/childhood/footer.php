...
<!--                </a>-->
            ...
            <div class="col-md-4 col-lg-3">
                <div class="footer__social">
                    ...
                    <?php
                        $inst = get_field('inst',2);
                        $facebook = get_field('facebook',2);
                        $YouTube = get_field('YouTube',2);

                        $array = [$inst,$facebook,$YouTube];

                        $instLog = '<svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        $facebookLog = '<svg width="13" height="24" viewBox="0 0 13 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        $YouTubeLog = '<svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        $arrayLog = [$instLog,$facebookLog,$YouTubeLog];
                        foreach($array as $elem => $value){
                            if($value == null){
                                continue;
                            }
                            echo(
                                   '<a href="'.$value.'" class="footer__social-item">'.
                                    $arrayLog[$elem].
                                    '</a>'
                            );
                ...
                <div class="footer__contacts">
                    <div class="footer__contacts-item">
                        ...
                        <div class="footer__contacts-tel">
                            <a href="tel:+<?php the_field('phone',2) ?>" class="header__contacts-mail">+<?php the_field('phone',2); ?></a>
                            <a href="tel:+<?php the_field('phone_2',2) ?>" class="header__contacts-mail">+<?php the_field('phone_2',2); ?></a>
                        </div>
                    </div>
                    <div class="footer__contacts-item">
                        ...
                        <address>
                            <?php
                            $adres = strval(get_field('adres',2));
                            ...
                            echo '<br>';
                            for ($i=(count($adress)/2);$i<(count($adress));$i++){
                                echo $adress[$i];
                                if(($i+1)===(count($adress))){
                                    echo '.';
                                }
